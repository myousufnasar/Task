...
<div id="Main" class="xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start h-full  w-full sm:w-64 bg-gray-900 flex-col">
  ...
  <div class="mt-6 flex flex-col justify-start items-center  pl-4 w-full border-gray-600 border-b space-y-3 pb-5 ">
    ...
    <div class=" bg-[#20354b] rounded-2xl w-full py-6 ">
    
        <div class="w-1/8 mx-auto flex justify-start">
            <img src="https://api.lorem.space/image/face?w=120&h=120&hash=bart89fe" class="rounded-full w-16 left inline-block" alt="profile picture" srcset=""/>
            <p class="text-white font-bold text-xl">Jonathan <br/> Smith</p>
        </div>
